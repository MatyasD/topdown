...
if (localStorage.getItem("char") === "joe"){
    characters.joe = new Joe(bodyElCenter.x, bodyElCenter.y, 100, new Gun(30, 5, 100, 100, 10, 3), 6, "assets/char1/char1.png")
}else if (localStorage.getItem("char") === "john"){
    characters.john = new John( bodyElCenter.x, bodyElCenter.y, 70, new Gun(7, 20, 1000, 30, 40, 5), 10, "assets/char2/char2.png")
}


playerChar = characters[localStorage.getItem("char")];
let game = new Game(playerChar, 0)
